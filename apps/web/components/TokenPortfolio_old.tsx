        ...
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            <div className="relative mb-6">
              ...
              <div className="absolute inset-0 w-12 h-12 border-4 border-transparent border-t-orange-300 rounded-full animate-spin mx-auto opacity-60" style={{animationDelay: '150ms'}}></div>
            </div>
    ...
    return (
      <div className={`card p-8 ${className}`}>
        <div className="text-center">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-4">Unable to Load Portfolio</h3>
